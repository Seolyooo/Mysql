...
insert into  tblproduct values ('1001','냉장고',800000,50,'LG전자','2022-01-06');
insert into  tblproduct values ('1002','노트북',1200000,50,'삼성전자','2022-01-07');
insert into  tblproduct values ('1003','모니터',350000,50,'LG전자','2023-01-13');
insert into  tblproduct values ('1004','세탁기',1000000,50,'삼성전자','2021-01-01');
insert into  tblproduct values ('1005','컴퓨터',1500000,50,'삼성전자','2023-10-01');
insert into  tblproduct values ('1006','휴대폰',950000,50,null,null);
